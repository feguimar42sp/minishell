...
#    Updated: 2024/12/11 21:43:30 by feguimar         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
STATICS_FOLDER := statics/env_vars_list.c statics/mem_list.c statics/args_list.c statics/current_exit_code.c \
	statics/prog_pid.c statics/running_loop.c statics/temp_env.c
...
RUN_COMMANDS_FOLDER := run_commands/run_commands.c run_commands/parse_redirect.c \
	...
	run_commands/run_curr_command.c run_commands/run_last_command.c run_commands/set_env.c run_commands/set_export.c
